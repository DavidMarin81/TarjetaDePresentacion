...
fun AppTarjeta(){
    Box(
        Modifier.fillMaxSize().background(Color.Green.copy(alpha = 0.5f))
    ) {
        Box(Modifier.align(Alignment.Center)) {
            PersonalDetails(name = "David Marín", job = "FullStack Developer", modifier = Modifier.align(Alignment.Center))
        }
...
fun MoreDetails(modifier: Modifier){
    Column(
        ...
        Details(detail = "687211097", painterResource(R.drawable.phone))
        Details(detail = "www.pamcollective.com", painterResource(R.drawable.web))
        Details(detail = "pamcollective@gmail.com", painterResource(R.drawable.email))
